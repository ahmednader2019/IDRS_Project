    ...
    <form method="POST" action="{{ URL('save') }}" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="personal_photo">
          ...
          <div style="margin-bottom: 20px;">
            ...
            <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="driver_licence">
          ...
          <div style="margin-bottom: 20px;">
            ...
            <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="car_licence">
